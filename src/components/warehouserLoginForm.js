...
import { warehouserLogin } from '../actions/auth';

function WarehouserLoginForm({
  warehouseModalOpen,
  ...
  async function onSubmit(e) {
    e.preventDefault();
    await dispatch(warehouserLogin(email, password));
  }
  ...
  return (
    ...
    >
      <Slide direction='left' in={warehouseModalOpen}>
...
export default WarehouserLoginForm;
